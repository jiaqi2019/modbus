...
def calculate(genmon):
    ...
    # 计算阻抗和角度
    impedance = math.sqrt(n1[15]**2 + (n1[5] * 22000 / 17127 / math.sqrt(3))**2)  # 阻抗
    delta = math.atan2(n1[5] * 22000 / 17127 / math.sqrt(3), n1[15])  # 阻抗角
    ...
    emffieldcurrent = emffieldcurrent * 1798
