...
Dim i0i As Integer
Dim fnumq As Single, gen1 As Single, xishu As Single
'由功率的到的电流平均值
'***********************************************************
...
'***********************************************************
   ...
   n1(14) = 42 '54
   n1(15) = 0.0015 '定子绕组直流电阻
   n1(19) = 18 '节距
   n1(5) = 0.1575 '定子绕组漏抗（标么）
  ...
  ' genmon(7) = 21940
   'genmon(9) = 3342.3
    ...
    'AEr
    impedance = Sqr((n1(15)) ^ 2 + (n1(5) * 22000 / 19245 / Sqr(3)) ^ 2)
    '1
    delta = Atn(n1(5) * 22000 / 19245 / Sqr(3) / n1(15)) '角度
    'AE
    ...
    If actualfieldcurrent > 0 Then
        panjuzjianjisuan = (genmon(9) - xishu * actualfieldcurrent) / actualfieldcurrent
